...
//            create_index.index_name, create_index.attribute_name[0], create_index.unique, false);
//        snprintf(response, sizeof(response), "%s\n",
//                 rc == RC::SUCCESS ? "SUCCESS" : "FAILURE");
//      } else {
...
//          rc = handler_->create_index(
//              current_trx, current_db, create_index.relation_name,
//              index_name.c_str(), create_index.attribute_name[i], create_index.unique, true);
//          if (rc != RC::SUCCESS) {
//            std::cout<<"xxx: "<< rc <<std::endl;
//            break;
//          }
//        }
//        snprintf(response, sizeof(response), "%s\n",
